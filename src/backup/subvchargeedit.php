      ...
      <table cellspacing="0" class="ewTable">
        ...
        <tr id="r_subvc_total"<?php echo $subvcharge->RowAttributes() ?>>
          ...
          <td<?php echo $subvcharge->subvc_total->CellAttributes() ?>><span id="el_subvc_total">
            <div<?php echo $subvcharge->subvc_total->ViewAttributes() ?>><?php echo $subvcharge->subvc_total->EditValue ?></div>
            <input type="hidden" name="x_subvc_total" id="x_subvc_total" value="<?php echo ew_HtmlEncode($subvcharge->subvc_total->CurrentValue) ?>" />
