...
define("EW_RANDOM_KEY", 'ByocpFb7NpyP4wO9', TRUE); // Random key for encryption
...
define("EW_CONN_HOST", 'mysql', TRUE);
define("EW_CONN_PORT", 3306, TRUE);
define("EW_CONN_USER", 'root', TRUE);
define("EW_CONN_PASS", 'example', TRUE);
define("EW_CONN_DB", 'cremation', TRUE);
...
$EW_LANGUAGE_FILE[] = array("en", "", "thai.xml");
...
// User table filters
define("EW_USER_TABLE", "`administrator`",  TRUE);
define("EW_USER_NAME_FILTER", "(`username` = '%u')",  TRUE);
define("EW_USER_ID_FILTER", "(`member_id` = %u)",  TRUE);
...
define("EW_EXPORT_CSS_STYLES", FALSE, TRUE); // TRUE to export CSS styles
...
if (function_exists("date_default_timezone_set"))
	date_default_timezone_set("Asia/Bangkok"); // Note: Change the timezone_identifier here
