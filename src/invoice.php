...
<center><a href="invoice.php?xprint=1" target="_blank"><img src="images/bt_print_invoice.png" width="129" height="37" border="0" /></a></center>
</p>
<?php	createInvoice($_SESSION['invoice']);
}else {
...
if ($xprint == 1){
createInvoice($_SESSION['invoice']);
//addSliptNumber();	
?>
...
class cinvoice {
	...
	function cinvoice() {
		...
		if (!defined("EW_PAGE_ID"))
			define("EW_PAGE_ID", 'invoice', TRUE);
