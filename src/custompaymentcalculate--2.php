    ...
    <tr>
      ...
      <table width="100%" border="1" cellpadding="3" cellspacing="3" class="ewTable">
        ...
        <tr id="r_min_advance_subv">
            ...
            <td align="left"><input name="dead_id" type="text" id="dead_id" /></td>
            </tr>
        <tr>
          <td align="left" class="ewTableHeader">ค่าสงเคราะห์ศพล่วงหน้า งวดที่:</td>
          <td align="left"><input type="text" name="adv_num" id="adv_num" /></td>
        </tr>
        <tr>
          <td align="left" class="ewTableHeader">ค่าบำรุงประจำปี:</td>
          <td align="left"><input type="text" name="annual_year" id="annual_year" /></td>
        </tr>
        <tr>
          <td align="left" class="ewTableHeader">ค่าสมัครสมาชิกจำนวน:</td>
          <?php $setting = getSetting();?> 
          <td align="left">
         <input name="regis_pay" type="text" id="regis_pay" /> บาท</td>
        </tr>
        <tr>
          <td align="left" class="ewTableHeader">อื่นๆ:            </td>
          <td align="left"><input name="other_detail" type="text" id="other_detail" size="30" /></td>
        </tr>
        </table> 
      </div></td>
    </tr>
