...
// Create page object
$setting_receiver_signature_blobview = new csetting_receiver_signature_blobview();
$Page =& $setting_receiver_signature_blobview;

// Page init
$setting_receiver_signature_blobview->Page_Init();

// Page main
$setting_receiver_signature_blobview->Page_Main();
?>
<?php
$setting_receiver_signature_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class csetting_receiver_signature_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'setting_receiver_signature_blobview';
	...
	//
	function csetting_receiver_signature_blobview() {
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('setting', 'x_receiver_signature');
		...
		if ($this->Recordset = $conn->Execute($sSql)) {
			if (!$this->Recordset->EOF) {
				...
				if (trim(strval($this->Recordset->fields('receiver_signature'))) <> "") {
					header("Content-Disposition: attachment; filename=" . $this->Recordset->fields('receiver_signature'));
				}
				$objBinary->Value = $this->Recordset->fields('receiver_signature');
