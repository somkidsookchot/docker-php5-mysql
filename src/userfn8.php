...
function Page_Unloaded() {
	...
	//echo "Page Unloaded";
		...
		function getRcBudgetAll($mid){                                      
				$total = ew_ExecuteScalar("SELECT sum(pay_sum_total) FROM  paymentsummary WHERE member_code = '".$mid."' AND pay_sum_type = 6 GROUP BY pay_sum_type "); 
	 ...
	 function getName($mid){
		...
		function getAsscTotal(){
			...
			$per = getAsscPercent();
			$subtotal = $setting[0]["max_subvention"];
		...
		function getAsscTotalByBnfcTotal($bnfctotal){
			
			$subtotal = getSubvTotal();
			$total = ($subtotal - $bnfctotal);
		...
		function getPayTypeTitle($payid){
			

			
			 $value = ew_ExecuteScalar("SELECT pt_title FROM  paymenttype WHERE pt_id = $payid");
...
<tr>
		 ...
		 }else if ($value['pay_sum_type'] == 6) {
			  echo "  ".$value['pay_sum_detail']." ";?><br />
			  จำนวน <?php echo getPayOtherCount($value['pay_sum_type'],$list,$value['pay_sum_detail']);?> ราย
		 <?php 
		 $total = (getPayOtherCount($value['pay_sum_type'],$list,$value['pay_sum_detail']) * $value['pay_sum_total']);
		 }else {	 
		  ?><br />
...
function createExpressSlipt($expid){
	
	$setting = getSetting();

 	global $conn;
			
	$rs = $conn->Execute("SELECT *  FROM expresspayment WHERE expr_id = $expid");
...
<font face="Cordia New" size="2">
  <table width="100%" align="center">
    <tr>
      <td width="200" align="left">เล่มที่ 1</td>
      <td align="center"><img src="upload/<?php echo $setting[0]["logo"]?>" alt="" width="131" height="139" vspace="10" /></td>
      <td width="200" align="right">เลขที่ <?php echo str_pad($arr[0]["expr_slipt_num"], 5, "0", STR_PAD_LEFT);?></td>
    </tr>
    <tr>
      <td colspan="3" align="center"><strong><br />
        ใบเสร็จรับเงิน<br />
...
อำเภอลี้   จังหวัดลำพูน</strong></td>
    ...
    <tr>
    <?php $tinfo = getTambonInfo($arr[0]['t_code']); $vinfo = getVillageInfo($arr[0]['village_id']);?>
      <td colspan="3" align="left"><strong>นาม</strong> ประธานกองทุนหมู่บ้าน  หมู่ <?php echo $vinfo[0]['v_code']." ".$vinfo[0]['v_title'];?>&nbsp;ตำบล <?php echo $tinfo[0]['t_title'] ?></td>
    </tr>
    <tr>
      <td colspan="3" align="left">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="3" align="left"><table width="100%" border="0" cellpadding="3" cellspacing="2">
        <tr>
          <td width="20" rowspan="2" align="center" style="border: solid 1px #999"><strong>ลำดับ</strong></td>
          <td width="463" rowspan="2" align="center" style="border: solid 1px #999"><strong>รายการ</strong></td>
          <td width="150" align="center" valign="top" style="border: solid 1px #999"><strong>จำนวนเงิน</strong></td>
        </tr>
        <tr>
          <td width="150" align="center" style="border: solid 1px #999"><strong>บาท</strong></td>
          </tr>
<?php 
$i = 1;
if ($arr[0]["subv_total"] > 0){?>
<tr>
  <td align="center" valign="top" style="border: solid 1px #999"><?php echo $i;?></td>
  <td valign="top" style="border: solid 1px #999">ค่าสงเคราะห์ศพ <?php echo $arr[0]["subv_detail"]?></td>
  <td valign="top" align="right" style="border: solid 1px #999"><?php echo number_format($arr[0]["subv_total"]);?></td>
</tr>
<?php 
$i+=1;
}?>
<?php 
if ($arr[0]["adv_total"] > 0){?>
<tr>
  <td align="center" valign="top" style="border: solid 1px #999"><?php echo $i;?></td>
  <td valign="top" style="border: solid 1px #999">ค่าสงเคราะห์ล่วงหน้า <?php echo $arr[0]["adv_detail"]?></td>
  <td valign="top" align="right" style="border: solid 1px #999"><?php echo number_format($arr[0]["adv_total"]);?></td>
</tr>
<?php 
$i+=1;
}?>
...
<tr>
  <td align="center" valign="top" style="border: solid 1px #999"><?php echo $i;?></td>
  <td valign="top" style="border: solid 1px #999">ค่าสงเคราะห์ย้อนหลัง <?php echo $arr[0]["rc_detail"]?></td>
  <td valign="top" align="right" style="border: solid 1px #999"><?php echo number_format($arr[0]["rc_total"]);?></td>
</tr>
<?php 
$i+=1;
}?>
<?php 
if ($arr[0]["annual_total"] > 0){?>
<tr>
  <td align="center" valign="top" style="border: solid 1px #999"><?php echo $i;?></td>
  <td valign="top" style="border: solid 1px #999">ค่าบำรุงประจำปี <?php echo $arr[0]["annual_detail"]?></td>
  <td valign="top" align="right" style="border: solid 1px #999"><?php echo number_format($arr[0]["annual_total"]);?></td>
</tr>
<?php 
$i+=1;
}?>
<?php 
if ($arr[0]["regis_total"] > 0){?>
<tr>
  <td align="center" valign="top" style="border: solid 1px #999"><?php echo $i;?></td>
  <td valign="top" style="border: solid 1px #999">ค่าสมัครสมาชิก <?php echo $arr[0]["regis_detail"]?></td>
  <td valign="top" align="right" style="border: solid 1px #999"><?php echo number_format($arr[0]["regis_total"]);?></td>
</tr>
<?php 
$i+=1;
}?>
<?php 
if ($arr[0]["other_total"] > 0){?>
<tr>
  <td align="center" valign="top" style="border: solid 1px #999"><?php echo $i;?></td>
  <td valign="top" style="border: solid 1px #999">ค่าอื่นๆ <?php echo $arr[0]["other_detail"]?></td>
  <td valign="top" align="right" style="border: solid 1px #999"><?php echo number_format($arr[0]["other_total"]);?></td>
</tr>
<?php 
$i+=1;
}?>
<?php $total = $arr[0]["subv_total"]+$arr[0]["adv_total"]+$arr[0]["annual_total"]+$arr[0]["regis_total"]+$arr[0]["other_total"]?>
<tr>
  <td align="center" valign="top" style="border: solid 1px #999">หมายเหตุ</td>
  <td valign="top" style="border: solid 1px #999">&nbsp;</td>
  <td valign="top" align="right" style="border: solid 1px #999">&nbsp;</td>
</tr>

        <tr>
          <td width="463" colspan="2" valign="middle" style="border: solid 1px #999"><table width="100%" cellpadding="1" >
            <tr>
                <td width="80%" align="center" valign="bottom"><strong>( <?php echo num2thai($total);?> )</strong></td>
                <td width="15%" align="center" valign="bottom" ><strong>รวมเงิน</strong></td>
              </tr>
          </table></td>
          <td width="150" valign="middle" align="right" style="border: solid 1px #999"><strong><?php echo number_format($total)?></strong></td>
          </tr>
      </table></td>
    </tr>
    <tr>
...
function createPaylogSlipt($pmid){
	
	$setting = getSetting();

 	global $conn;
			
	$rs = $conn->Execute("SELECT *  FROM paymentlog WHERE pml_id = $pmid");
...
<font face="Cordia New" size="2">
  <table width="100%" align="center">
    <tr>
      <td width="200" align="left">เล่มที่ 1</td>
      <td align="center"><img src="upload/<?php echo $setting[0]["logo"]?>" alt="" width="131" height="139" vspace="10" /></td>
      <td width="200" align="right">เลขที่ <?php echo str_pad($arr[0]["pml_slipt_num"], 5, "0", STR_PAD_LEFT);?></td>
    </tr>
    <tr>
      <td colspan="3" align="center"><strong><br />
        ใบเสร็จรับเงิน<br />
...
อำเภอลี้   จังหวัดลำพูน</strong></td>
    ...
    <tr>
      <td colspan="3" align="right">ชำระเมื่อ <?php echo date2Thai($arr[0]['pay_date']);?></td>
    </tr>
    <tr>
    <?php $tinfo = getTambonInfo($arr[0]['t_code']); $vinfo = getVillageInfo($arr[0]['village_id']);?>
      <td colspan="3" align="left"><strong>นาม</strong> ประธานกองทุนหมู่บ้าน  หมู่ <?php echo $vinfo[0]['v_code']." ".$vinfo[0]['v_title'];?>&nbsp;ตำบล <?php echo $tinfo[0]['t_title'] ?></td>
    ...
    <tr>
      <td colspan="3" align="left"><table width="100%" border="0" cellpadding="3" cellspacing="2">
        <tr>
          <td width="463" align="center" style="border: solid 1px #999"><strong>รายการ</strong></td>
          <td width="150" align="center" valign="top" style="border: solid 1px #999"><strong>จำนวน</strong></td>
        </tr>
        <tr>
          <td valign="top" style="border: solid 1px #999"><?php echo getPayTypeTitle($arr[0]["pay_type"]);?><?php if($arr[0]["pay_detail"]) {?> งวดที่/ปี <?php echo $arr[0]["pay_detail"]?><?php } ?></td>
          <td valign="top" align="right" style="border: solid 1px #999">&nbsp;</td>
</tr>
<tr>
  <td align="right" valign="top" style="border: solid 1px #999">จำนวนสมาชิก</td>
  <td valign="top" align="right" style="border: solid 1px #999"><?php echo $arr[0]["count_member"]?> คน</td>
</tr>
<tr>
  <td align="right" valign="top" style="border: solid 1px #999">ยอดชำระต่อราย</td>
  <td valign="top" align="right" style="border: solid 1px #999"><?php echo $arr[0]["pay_rate"]?><strong> บาท</strong></td>
</tr>
<tr>
  <td align="right" valign="top" style="border: solid 1px #999">รวมเป็นเงิน</td>
  <td valign="top" align="right" style="border: solid 1px #999"><?php echo number_format($arr[0]["sub_total"])?><strong> บาท</strong></td>
</tr>

<tr>
  <td align="right" valign="top" style="border: solid 1px #999">หักเข้าชมรม</td>
  <td valign="top" align="right" style="border: solid 1px #999"><?php echo $arr[0]["assc_rate"]?> %</td>
</tr>
<tr>
  <td align="right" valign="top" style="border: solid 1px #999">รวมเป็นเงิน</td>
  <td valign="top" align="right" style="border: solid 1px #999"><?php echo number_format($arr[0]["assc_total"])?><strong> บาท</strong></td>
</tr>
<tr>
  <td width="463" valign="middle" style="border: solid 1px #999"><table width="100%" align="right" cellpadding="1" >
    <tr>
      <td width="80%" align="center" valign="bottom"><strong>( <?php echo num2thai($arr[0]["grand_total"]);?> )</strong></td>
      <td width="15%" align="right" valign="bottom" ><strong>รวมเงิน</strong></td>
      </tr>
    </table></td>
  <td width="150" valign="middle" align="right" style="border: solid 1px #999"><strong><?php echo number_format($arr[0]["grand_total"])?></strong><strong>บาท</strong></td>
</tr>
        <tr>
          <td colspan="2" valign="middle" style="border: solid 1px #999">หมายเหตุ&nbsp;<?php echo $arr[0]["pay_note"]?></td>
          </tr>
      </table></td>
    </tr>
    <tr>
...
function getPayLogSliptNumber(){
	
$total = ew_ExecuteScalar("SELECT number FROM sliptnumber WHERE slipt_id = 4");
...
function addPayLogSliptNumber(){
	
$old = getPayLogSliptNumber();
$add = $old+1;	
	
$total = ew_ExecuteScalar("UPDATE sliptnumber SET number = ".$add." WHERE slipt_id = 4"); 
...
function countPayRcMemberInvillage($vid,$date){
	
			 $all = ew_ExecuteScalar("SELECT count(member_code) FROM  paymentsummary WHERE village_id = ".$vid." AND pay_sum_type =6 AND member_code IN (SELECT member_code FROM  members WHERE village_id = ".$vid." AND member_status = 'ปกติ' AND regis_date > '".$date."')");
...
$minrate = $setting[0]["min_advance_subv"];
//$unitrate = ($setting[0]["max_advance_subv"]*$setting[0]["subvention_rate"]);
$unitrate = $setting[0]["max_advance_subv"];
...
function calculateRcSubv(){

$setting = getSetting();

$unitrate = $setting[0]["rc_rate"];
$date = $setting[0]["start_date"];
...
$conn->Execute("DELETE FROM subvcalculate WHERE cal_type = 6");
$conn->Execute("DELETE FROM unpaylist WHERE un_pay_type = 6");
$varr = ""; 

foreach ($village as $value){
	
	$member = $conn->Execute("SELECT * FROM  members WHERE village_id = ".$value["village_id"]." AND member_status = 'ปกติ' AND regis_date > '".$date."'");
$memberlist = $member->GetArray();
	
	$paidmember = countPayRcMemberInvillage($value["village_id"],$date);

	$unpaymember = count($memberlist) - $paidmember;
	
	
	if ($unpaymember > 0){
		
		
		$conn->Execute("INSERT INTO subvcalculate SET t_code = '".$value["t_code"]."', village_id = '".$value["village_id"]."',cal_type = '6', cal_detail = 'ค่าสงเคราะห์ย้อนหลัง', cal_date = '".date('Y/m/d')."', count_member = ".$unpaymember.", unit_rate = ".$unitrate.", total = (".$unitrate."*".$unpaymember.")");
		
		
		$lastid = ew_ExecuteScalar("SELECT max(svc_id) FROM subvcalculate");
		
       $notpay =  getNotPayRcList($value["village_id"],true);
	 
	 //$mb = getMemberByVillage($value["village_id"]);

		$nmember = $conn->Execute("SELECT * FROM  members WHERE village_id = ".$value["village_id"]." AND member_status = 'ปกติ' AND regis_date > '".$date."' AND member_code NOT IN (select member_code from paymentsummary where pay_sum_type = 6)");
$nmemberlist = $nmember->GetArray();
	   
	    foreach($nmemberlist as $notvalue){
		$varr .=",(".$lastid.",".getMemberIdByCode($notvalue["member_code"]).",6)";
		}
...
//	$unpaymember = $allmember - $paidmember;
	...
	if ($unpaymember > 0){
     ...
     //  $notpay =  getNotPayDeadList(1,$value["village_id"],$member,true);
	 		...
	 		$nmember = $conn->Execute("SELECT * FROM  members WHERE village_id = ".$value["village_id"]." AND member_status = 'ปกติ' AND regis_date > '".$date."' AND member_code NOT IN (select member_code from paymentsummary where pay_sum_type = 4)");
$nmemberlist = $nmember->GetArray();
...
$setting = getSetting();
$unitrate = $setting[0]["annual_rate"];
...
function getNotPayRcList($vid,$showarr = false){

			global $conn;
			
			
			
			$paylist = $conn->Execute("SELECT un_member_id, member_code, cal_detail, adv_num FROM  unpaylist LEFT JOIN subvcalculate ON (subvcalculate.svc_id = unpaylist.svc_id) WHERE cal_type = 6 AND village_id = ".$vid);
...
function getSubvTotalByVillage($village_id){

			$total = ew_ExecuteScalar("SELECT sum(total) FROM  subvcalculate WHERE village_id  = ".$village_id." AND cal_type = 1");
			
			$paid = ew_ExecuteScalar("SELECT sum(subv_total) FROM  expresspayment WHERE village_id  = ".$village_id);
			
			$total = $total - $paid;

			if ($total > 0) return number_format($total);
			else return 0;
}
function getAdvTotalByVillage($village_id){

			$total = ew_ExecuteScalar("SELECT sum(total) FROM  subvcalculate WHERE village_id  = ".$village_id." AND cal_type = 2");
			
			$paid = ew_ExecuteScalar("SELECT sum(adv_total) FROM  expresspayment WHERE village_id  = ".$village_id);
...
function getAnnualTotalByVillage($village_id){

			$total = ew_ExecuteScalar("SELECT sum(total) FROM  subvcalculate WHERE village_id  = ".$village_id." AND cal_type = 3");
			
			$paid = ew_ExecuteScalar("SELECT sum(annual_total) FROM  expresspayment WHERE village_id  = ".$village_id);
...
function getRegisTotalByVillage($village_id){

			$total = ew_ExecuteScalar("SELECT sum(total) FROM  subvcalculate WHERE village_id  = ".$village_id." AND cal_type = 4");
			
			$paid = ew_ExecuteScalar("SELECT sum(regis_total) FROM  expresspayment WHERE village_id  = ".$village_id);
...
function getOtherTotalByVillage($village_id){

			$total = ew_ExecuteScalar("SELECT sum(total) FROM  subvcalculate WHERE village_id  = ".$village_id." AND cal_type = 5");
			
			
			$paid = ew_ExecuteScalar("SELECT sum(other_total) FROM  expresspayment WHERE village_id  = ".$village_id);
...
function getExprSliptNum(){
	
	$total = ew_ExecuteScalar("SELECT max(expr_slipt_num) FROM  expresspayment");

	if ($total > 0) return number_format($total);
	else return 0;
}
function getRecentPayList($row=2){
	
	 global $conn;
	 $rs  = $conn->Execute("SELECT * FROM paymentlog left join paymenttype on (paymentlog.pay_type = paymenttype.pt_id) order by pml_id DESC limit 0, $row"); 
	 $arr = $rs->GetArray(); ?>
<table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#33CCFF" style="font-size:11px; color:#000;">
  <tr>
  <td colspan="3" align="center" bgcolor="#406DD6">
    <form id="form1" name="form1" method="get" action="">
      <label for="row"></label>
  &nbsp;จำนวน
  <input name="row" type="text" id="row" style="font-size:10px;" size="5"/>
      รายการ
  <input type="submit" name="act" id="act" value="แสดง" style="font-size:10px;"/>
  </form></td>
  </tr>
<tr>
	     <td width="50" align="center" bgcolor="#00CCFF"><strong>ใบเสร็จ</strong></td>
	     <td align="center" bgcolor="#00CCFF"><strong>รายการที่ชำระ</strong></td>
	     <td align="right" bgcolor="#00CCFF"><strong>ยอดเงิน</strong></td>
  </tr>
       <?php 
	   $total = 0;
	   foreach($arr as $k => $v){
		 ...
		 ?>
	   <tr>
	     <td align="center" bgcolor="#FFFFFF"><?php echo $v["pml_slipt_num"]?></td>
	     <td bgcolor="#FFFFFF"><?php echo $v["pt_title"]?></td>
	     <td align="right" bgcolor="#FFFFFF"><?php echo number_format($v["grand_total"])?></td>
      </tr>
       <?php } ?>	   
       <tr>
	     <td align="center" bgcolor="#FFFFFF">&nbsp;</td>
	     <td align="right" bgcolor="#FFFFFF"><strong>ยอดรวม</strong></td>
	     <td align="right" bgcolor="#FFFFFF"><strong><?php echo number_format($total)?></strong></td>
      </tr>
</table>
<?php
}
