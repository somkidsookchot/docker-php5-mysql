...
define("EWRPT_PROJECT_NAME", "phpmaker", TRUE); // Project Name
define("EWRPT_PROJECT_VAR", "phpmaker", TRUE); // Project Var
...
$EWRPT_LANGUAGE_FILE[] = array("en", "", "thai.xml");
...
define("EWRPT_CONN_DB", 'cremation', TRUE);
...
// General
define("EWRPT_ROOT_RELATIVE_PATH", "..\cremationreport", TRUE); // Relative path of app root
define("EWRPT_DEFAULT_DATE_FORMAT", "dd/mm/yyyy", TRUE); // Default date format
define("EWRPT_DATE_SEPARATOR", "/", TRUE); // Date separator
define("EWRPT_RANDOM_KEY", '#&YZ#W&5C#_y1znV', TRUE); // Random key for encryption
define("EWRPT_PROJECT_STYLESHEET_FILENAME", "phpcss/phpmaker.css", TRUE); // Project stylesheet file name
 ...
 */
define("EWRPT_ENCODING", "UTF-8", TRUE); // Character encoding
 ...
 */
define("EWRPT_MYSQL_CHARSET", "utf8", TRUE);
...
// Filter
define("EWRPT_FILTER_PANEL_OPTION", 1, TRUE); // 1/2/3, 1 = always hide, 2 = always show, 3 = show when filtered
...
// User admin
define("EWRPT_LOGIN_SELECT_SQL", "SELECT * FROM `administrator`", TRUE);

// User table filters
define("EWRPT_USER_NAME_FILTER", "(`username` = '%u')",  TRUE);
define("EWRPT_USER_ID_FILTER", "(`member_id` = %u)",  TRUE);
define("EWRPT_USER_ACTIVATE_FILTER", "",  TRUE);
...
define("EWRPT_EMAIL_CHARSET", "utf-8", TRUE); // Email charset
define("EWRPT_EMAIL_WRITE_LOG", FALSE, TRUE); // Write to log file
