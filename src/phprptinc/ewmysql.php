...
/**
 * MySQL API for PHP Report Maker 4
 ...
 */
$PHPReportMaker_vers = 'PHP Report Maker 4 (C) 2007-2010 e.World Technology Limited';
define('ADODB_FETCH_DEFAULT', 0);
define('ADODB_FETCH_NUM', 1);
define('ADODB_FETCH_ASSOC', 2);
define('ADODB_FETCH_BOTH', 3);
define('EWRPT_USE_MYSQLI', FALSE && extension_loaded("mysqli"), TRUE);
