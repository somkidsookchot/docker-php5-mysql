...
<table border="0" cellspacing="0" cellpadding="4">
	...
	<tr>
		...
		<input type="radio" name="rememberme" id="rememberme" value="a"<?php if ($rptlogin->LoginType == "a") { ?> checked="checked"<?php } ?> /><?php echo $ReportLanguage->Phrase("AutoLogin") ?><br />
		<input type="radio" name="rememberme" id="rememberme" value="u"<?php if ($rptlogin->LoginType == "u") { ?>  checked="checked"<?php } ?> /><?php echo $ReportLanguage->Phrase("SaveUserName") ?><br />
		<input type="radio" name="rememberme" id="rememberme" value=""<?php if ($rptlogin->LoginType == "") { ?> checked="checked"<?php } ?> /><?php echo $ReportLanguage->Phrase("AlwaysAsk") ?><br />
		</span></td>
	</tr>
	<tr>
