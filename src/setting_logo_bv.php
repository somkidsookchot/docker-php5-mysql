...
// Create page object
$setting_logo_blobview = new csetting_logo_blobview();
$Page =& $setting_logo_blobview;

// Page init
$setting_logo_blobview->Page_Init();

// Page main
$setting_logo_blobview->Page_Main();
?>
<?php
$setting_logo_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class csetting_logo_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'setting_logo_blobview';
	...
	//
	function csetting_logo_blobview() {
